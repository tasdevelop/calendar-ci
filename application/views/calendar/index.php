...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url().'libraries/font-awesome/css/font-awesome.min.css'; ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url().'libraries/plugins/fullcalendar/fullcalendar.css'; ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url().'libraries/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css'; ?>">
    </head>
    <body>
    ...
    <script type="text/javascript" src="<?php echo base_url().'libraries/js/moment.min.js'; ?>"></script>
    <script type="text/javascript" src="<?php echo base_url().'libraries/js/bootstrap.min.js'; ?>"></script>
    <script type="text/javascript" src="<?php echo base_url().'libraries/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js'; ?>"></script>
    <script type="text/javascript" src="<?php echo base_url().'libraries/plugins/fullcalendar/fullcalendar.js'; ?>"></script>
