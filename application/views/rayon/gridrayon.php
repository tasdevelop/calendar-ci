<script type="text/javascript">
    ...
    function newData(){
        $('#dlg').dialog({
            closed:false,
            title:'Tambah data',
            href:'<?php echo base_url(); ?>rayon/add',
            onLoad:function(){
    ...
    function editData(parameter_key){
        ...
        if (row!=''){
            $('#dlg').dialog({
                closed:false,
                title:'Edit rayon',
                href:'<?php echo base_url(); ?>rayon/edit/'+row,
                onLoad:function(){
    ...
    function viewData(parameter_key){
        ...
        if (row!=''){
            $('#dlgView').dialog({
                closed:false,
                title:'View data',
                href:'<?php echo base_url(); ?>rayon/view/'+row
            });
    ...
    function deleteData(parameter_key){
        ...
        if (row!=''){
            $('#dlg').dialog({
                closed:false,
                title:'Delete data',
                href:'<?php echo base_url(); ?>rayon/delete/'+row,
                onLoad:function(){
...
<div class="easyui-tabs" style="height:auto">
    <div title="Data rayon" style="padding:10px">
         <table id="dg" title="rayon" class="easyui-datagrid" style="width:100%;height:250px" url="<?= $link ?>"
                >
            <thead>
                <tr>
